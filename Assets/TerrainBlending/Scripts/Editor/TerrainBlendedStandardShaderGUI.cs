...
{
    internal class TerrainBlendedStandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static string terrainBlendingText = "Terrain blending";
        ...
        MaterialProperty terrainBlendingStart = null;
        MaterialProperty terrainBlendingEnd = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            terrainBlendingStart = FindProperty("_TerrainBlendingStart", props);
            terrainBlendingEnd = FindProperty("_TerrainBlendingEnd", props);
        }
