    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexOutputForwardTerrainBlended vertTerrainBlended (VertexInput v) 
            {
                ...
                VertexOutputForwardTerrainBlended vertexOutputForwardTerrainBlended;                
                WrapVertexOutput( o, vertexOutputForwardTerrainBlended );
                
                return vertexOutputForwardTerrainBlended; 
            }
            
            half4 fragTerrainBlended (VertexOutputForwardTerrainBlended vertexOutputForwardTerrainBlended) : SV_Target 
            {
                VertexOutputForwardBase i;
                WrapVertexOutput( vertexOutputForwardTerrainBlended, i );
